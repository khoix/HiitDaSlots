...
import { ArrowLeft, ChevronDown, ExternalLink, Star, Wrench, X } from "lucide-react";
          ...
          {sections.map((sec) =>
            sec.rows.map((row, idx) => {
              ...
              return (
                <article
                  key={canonicalKey}
                  id={isFirst ? anchorId(sec.letter) : undefined}
                ...
                >
                  <div className="flex items-start justify-between gap-3 mb-2">
                    ...
                    <div className="flex shrink-0 items-start gap-1">
                      ...
                      <button
                        ...
                        title={
                          starred ? "Remove from favorites" : "Favorite exercise"
                        }
                  ...
                  <div className="flex flex-wrap items-center gap-2 gap-y-2">
                    ...
                    <button
                      ...
                      disabled={!hasDemo}
                      title={
                        hasDemo ? "Open demo in browser" : "No demo available"
                      }
                      className={cn(
